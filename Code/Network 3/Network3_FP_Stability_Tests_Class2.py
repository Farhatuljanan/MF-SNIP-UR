...
data1= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Reduced A')
data2= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Reduced_AR')
data3= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Reduced_AuAR')
data4= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Sheet8')
data5= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Red_nodes_ResArc')
data6= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Comb')
data7= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Sij')
data8= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='NetA')
data9= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Sheet3')
data10= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Second_tier')
data11= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Sheet12')
data12= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Extra_Arcs_Partial')
data13= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='ResAR')
data14= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Sheet4')
...
for l1 in a7:
    out_edges = list(A.out_edges(l1+230+node_expansion_start_node))
...
file_path = 'elapsed time_base3_HM_2(n_10,m_5).xlsx'
...
excel_file_path = 'combined_base3_HM_2(n_10,m_5).xlsx'
...
file_path_pickle = 'z_values_base3_Stability_HM_10(25)_Class2.pkl'
...
data5= pd.read_excel(r'D:\PhD Research\First_paper\200users_3_base\200users_3_base.xlsx', sheet_name='Sheet13')
...
file_path = 'elapTimeUB_Base3_Heu_out_of_sample_in_FP_Class2(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base3_Heu_out_of_sample_in_FP_Class2(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica_in_sample)
file_path = 'elapTimeUB_Base3_Heu_in_sample_in_FP_Class2(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base3_Heu_in_sample_in_FP_Class2(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
  #  aR=aR+T
