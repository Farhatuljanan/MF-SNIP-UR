...
#data1= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Reduced_A',engine='openpyxl')
#data2= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Reduced_AR',engine='openpyxl')
#data3= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Reduced_AuAR',engine='openpyxl')
#data4= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Sheet8',engine='openpyxl')
#data5= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Red_nodes_ResArc',engine='openpyxl')
#data6= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Comb',engine='openpyxl')
#data7= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Sij',engine='openpyxl')
#data8= pd.read_excel(r'200users_3_base.xlsx', sheet_name='NetA',engine='openpyxl')
#data9= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Sheet3',engine='openpyxl')
#data10= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Second_tier',engine='openpyxl')
#data11= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Sheet12',engine='openpyxl')
#data12= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Extra_Arcs_Partial',engine='openpyxl')
#data13= pd.read_excel(r'200users_3_base.xlsx', sheet_name='ResAR',engine='openpyxl')
#data14= pd.read_excel(r'200users_3_base.xlsx', sheet_name='Sheet4',engine='openpyxl')
...
# Specify the Excel file path
excel_file_path1 = 'Obj_valueLB_base3_HM_2(n_10,m_5).xlsx'
...
file_path_pickle = 'z_values_base3_HM_2(n_10,m_5).pkl'
...
file_path = 'elapTimeUB_Base2_HM_2(n,10_M,5).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Objective_Value)
file_path = 'ObjUB_Base2_HM_2(n,10_M,5)_check.xlsx'
