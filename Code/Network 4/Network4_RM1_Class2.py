...
file_path = 'elapsed time_base4_RM1_2(n,10_m,5).xlsx'
...
excel_file_path = 'combined_base4_RM1_2(n,10_m,5).xlsx'
...
# Specify the Excel file path
excel_file_path1 = 'Obj_valueLB_base4_RM1_2(n,10_m,5).xlsx'
...
file_path_pickle = 'z_values_base4_RM1_prac.pkl'
...
file_path = 'elapTimeUB_Base4_RM1_Class2(n,10_M,5).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Objective_Value_UB)
file_path = 'ObjUB_Base4_RM1_Class2(n,10_M,5)_check.xlsx'
