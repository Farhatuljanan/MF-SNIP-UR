# -*- coding: utf-8 -*-
"""
Created on Thu Dec 12 19:56:55 2024
...
file_path = 'elapsed time_base1_HM_2(n_10,m_5).xlsx'
...
# Specify the Excel file path
excel_file_path1 = 'Obj_valueLB_base1_HM_2(n_10,m_5).xlsx'
...
file_path_pickle = 'z_values_base1_HM_2(n_10,m_5).pkl'
...
#for l in L:  
  ...
  UpperBound[iUB]=np.mean(Objective_Value[:,iUB])
  
ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica)
file_path = 'elapTimeUB_Base1_HM_2(n,10_M,5).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Objective_Value)
file_path = 'ObjUB_Base1_HM_2(n,10_M,5)_check.xlsx'
