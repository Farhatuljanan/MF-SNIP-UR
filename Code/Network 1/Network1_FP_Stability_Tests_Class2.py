...
data1= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Reduced A')
data2= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Reduced_AR')
data3= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Reduced_AuAR')
data4= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Sheet8')
data5= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Red_nodes_ResArc')
data6= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Comb')
data7= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Sij')
data8= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='NetA')
data9= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Sheet3')
data10= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Second_tier')
data11= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Sheet12')
data12= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Extra_Arcs_Partial')
data13= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='ResAR')
data14= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Sheet4')

#data1= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Reduced A',engine='openpyxl')
#data2= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Reduced_AR',engine='openpyxl')
#data3= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Reduced_AuAR',engine='openpyxl')
#data4= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Sheet8',engine='openpyxl')
#data5= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Red_nodes_ResArc',engine='openpyxl')
#data6= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Comb',engine='openpyxl')
#data7= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Sij',engine='openpyxl')
#data8= pd.read_excel(r'200users_1_base.xlsx', sheet_name='NetA',engine='openpyxl')
#data9= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Sheet3',engine='openpyxl')
#data10= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Second_tier',engine='openpyxl')
#data11= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Sheet12',engine='openpyxl')
#data12= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Extra_Arcs_Partial',engine='openpyxl')
#data13= pd.read_excel(r'200users_1_base.xlsx', sheet_name='ResAR',engine='openpyxl')
#data14= pd.read_excel(r'200users_1_base.xlsx', sheet_name='Sheet4',engine='openpyxl')
...
for l1 in a7:
    out_edges = list(A.out_edges(l1+232+264))
...
for l1 in a7_full:
    out_edges_full = list(A_full.out_edges(l1+200+265))
...
random_integers = [random.randint(1, 100) for _ in range(7)]
M1=list(range(0,M))
S=list(range(0,n)) 
...
file_path = 'elapsed time_base1_Heu_ModCap_1(n_10,m_5).xlsx'
...
excel_file_path = 'combined_base1_Heu_ModCap_1(n_10,m_5).xlsx'
...
file_path_pickle = 'z_values_base1_Heu_10(25)_Class2.pkl'
...
data5= pd.read_excel(r'D:\PhD Research\First_paper\200users_1_base\200users_1_base.xlsx', sheet_name='Sheet13')
...
Objective_Value_UB=np.zeros((len(S3)))
...
#file_path_pickle ='z_values_base1_HeuCap_Stability_1(n_20,m_13_25).pkl'
#with open(file_path_pickle, 'rb') as pickle_file:
...
unique_edges = A.edges - S_ij.edges  
a4=list(range(0,n1))
elapsed_time_Replica_out_of_sample = np.zeros((len(S3),len(No_UB)))
Obj_Val_FP_out_of_sample=np.zeros((len(S3),len(No_UB)))
elapsed_time_Replica_in_sample = np.zeros((len(S3),len(No_UB)))
Obj_Val_FP_in_sample=np.zeros((len(S3),len(No_UB)))
# Generate a list of random integers
seed_value = 1
random.seed(seed_value)
random_integers = [random.randint(1, 100) for _ in range(30)]
...
#a_in=list(range(0,13))
#for i in a_in:
 #   Final_interdiction[12+i]=Interdiction_Values1[i]
S4=list(range(0,n1))
#for l in L:
...
#Objective_Value_UB_in_sample=np.zeros((len(S3),len(No_UB)))
seed_value = 1
random.seed(seed_value)
# Generate a list of random integers
random_integers = [random.randint(1, 100) for _ in range(30)]
...
#for l in L:  
  ...
  for l in S3:
    ...
    m1.optimize()
    end_time_Replica=time.time() 
    elapsed_time_Replica_out_of_sample[l][iUB]=end_time_Replica - start_time_Replica
    Obj_Val_FP_out_of_sample[l][iUB]= m1.objVal
    
    
    ##in sample
    m1_in = gp.Model("Network_Dual_UB_in")
    start_time_Replica=time.time()
    # Decision variable: Binary variable indicating if an edge is selected
    theta1 = m1_in.addVars(AuAR.edges, S5, vtype=GRB.CONTINUOUS, name="theta1")
    pi1 = m1_in.addVars(AuAR.nodes, S5, vtype=GRB.CONTINUOUS, name="pi1")
    mu1 = m1_in.addVars(A.edges, S5,  vtype=GRB.CONTINUOUS, name="mu1")
    delta1 = m1_in.addVars(AR.edges, S5, vtype=GRB.CONTINUOUS, name="delta1")
    phi1 = m1_in.addVars(AR.edges, S5, vtype=GRB.CONTINUOUS, name="phi1")
    v1 = m1_in.addVars(AR.edges, S5,  vtype=GRB.CONTINUOUS, name="v1")
    alpha1= m1_in.addVars(A.edges, S5, vtype=GRB.BINARY, name="alpha")
    #Objective function: Min-cut (Dual of max flow)
    m1_in.setObjective(gp.quicksum((1/len(S5)) * (gp.quicksum(A[i][j]['Capacity'] *  mu1 [i, j,s] for i, j in A.edges)+ gp.quicksum(AR[i][j]['Capacity'] * v1[i,j,s] for i, j in AR.edges)) for s in S5), GRB.MINIMIZE)
    
    # Constraints: Ensure connectivity
    m1_in.addConstrs(pi1[i,s]-pi1[j,s]+theta1[i, j,s]>=0 for i, j in AuAR.edges for s in S5)
    m1_in.addConstrs(pi1[sink,s]-pi1[source,s]>=1 for s in S5)
    arcs_As=[]
    arcs_As1=[]
    rand_a_b={}
    #selecting specific scenario and assigning a_{ij} and b_{ij} to the arcs of network AuAR and then adding the constraints
    for s in S5:  
       ...
       for r,t in unique_edges:
           if AuAR[r][t]['Rand']==1:
               ...
               m1_in.addConstr(alpha1[r,t,s]==0) 
       for r,t in S_ij.edges:
           if AuAR[r][t]['Rand']==0:
               m1_in.addConstr(alpha1[r,t,s]==0)
           else:
               if A[r][t]['Tau']>sum(AuAR[r1][t1]['Rand'] for r1,t1 in S1[(r,t)]):
                   m1_in.addConstr(alpha1[r,t,s]==0)
       m1_in.addConstrs(alpha1[i,j,s]<=AuAR[i][j]['Rand'] * A[i][j]['Interdict'] for i,j in S_ij.edges)
       m1_in.addConstrs(alpha1[i,j,s]==AuAR[i][j]['Rand'] * A[i][j]['Interdict'] for i,j in unique_edges)
       for i, j in AR.edges:
               #H[c][d]['sum']=gp.quicksum(G[p][q]['Capacity'] for p, q in arc_lists[(c, d)])    
           m1_in.addConstrs(phi1[i, j, s] >= alpha1[k,l,s] for k, l in R[(i,j)])
       m1_in.addConstrs(mu1[p,q,s]+alpha1[p,q,s]  - theta1[p,q,s] >= 0 for  p, q in A.edges)
       m1_in.addConstrs(delta1[p,q,s]-AuAR[p][q]['Rand'] * theta1 [p,q,s] >= 0 for p,q in AR.edges)
       m1_in.addConstrs(gp.quicksum(alpha1[k,l,s] for k,l in S1[(i,j)])>=A[i][j]['Tau'] * alpha1[i,j,s] for i,j in S_ij.edges)

    m1_in.addConstrs(v1[i,j,s]<= delta1[i,j,s] for i,j in AR.edges for s in S5)
    m1_in.addConstrs(v1[i,j,s]<= phi1[i,j,s] for i,j in AR.edges for s in S5)
    m1_in.addConstrs(v1[i,j,s]>= delta1[i,j,s] + phi1[i,j,s] - 1 for i,j in AR.edges for  s in S5)
    start_time_Replica=time.time()
    # Optimize the model
    m1_in.optimize()
    end_time_Replica=time.time() 
    elapsed_time_Replica_in_sample[l][iUB]=end_time_Replica - start_time_Replica
    Obj_Val_FP_in_sample[l][iUB]= m1_in.objVal

Mean_in_sample=np.mean(Obj_Val_FP_in_sample)
Standard_Deviation_in_sample=np.std(Obj_Val_FP_in_sample)
Mean_out_of_sample=np.mean(Obj_Val_FP_out_of_sample)
Standard_Deviation_out_of_sample=np.std(Obj_Val_FP_out_of_sample)

ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica_out_of_sample)
file_path = 'elapTimeUB_Base1_Heu_out_of_sample_in_FP_Class2(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base1_Heu_out_of_sample_in_FP_Class2(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica_in_sample)
file_path = 'elapTimeUB_Base1_Heu_in_sample_in_FP_Class2(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base1_Heu_in_sample_in_FP_Class2(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
  #  aR=aR+T
