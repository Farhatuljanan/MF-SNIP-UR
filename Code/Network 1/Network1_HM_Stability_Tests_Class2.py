...
file_path_pickle = 'z_values_base1_Stability_Heu_10(25)_Class2.pkl'
...
file_path = 'elapTimeUB_Base1_HeuCap_out_of_sample_Class2(n,10_M,25(5000)).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)

Ob_UB_M1=pd.DataFrame(Obj_Val_UB_HM_out_of_sample)
file_path = 'ObjUB_Base1_HeuCap_out_of_sample_Class2(n,10_M,25(5000)).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)

ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica1_in_sample)
file_path = 'elapTimeUB_Base1_HeuCap_in_sample_Class2(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
