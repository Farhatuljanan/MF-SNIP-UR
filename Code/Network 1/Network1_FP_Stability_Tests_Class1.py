...
file_path_pickle = 'z_values_base1_Stability_Heu.pkl'
...
#for l in L:  
  ...
  for l in S3:
    ...
    #matrix_sequence = [np.random.choice([0,1], size=(rand_num, len(S4))) for _ in range(1)]
    matrix_sequence1 = [np.random.choice([0,1], size=(rand_num, len(S5))) for _ in range(1)]
...
file_path = 'elapTimeUB_Base1_Heu_out_of_sample_in_FP_1(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base1_Heu_out_of_sample_in_FP_1(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica_in_sample)
file_path = 'elapTimeUB_Base1_Heu_in_sample_in_FP_1(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base1_Heu_in_sample_in_FP_1(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
  #  aR=aR+T
