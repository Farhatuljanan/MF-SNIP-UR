...
data1= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Reduced A')
data2= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Reduced_AR')
data3= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Reduced_AuAR')
data4= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Sheet8')
data5= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Red_nodes_ResArc')
data6= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Comb')
data7= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Sij')
data8= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='NetA')
data9= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Sheet3')
data10= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Second_tier')
data11= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Sheet12')
data12= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Extra_Arcs_Partial')
data13= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='ResAR')
...
file_path = 'elapsed time_base5_Heu_1(n_10,m_25).xlsx'
...
excel_file_path = 'combined_base5_Heu_1(n_10,m_25).xlsx'
...
file_path_pickle = 'z_values_base5_Stability_Heu_10(25).pkl'
...
data5= pd.read_excel(r'D:\PhD Research\First_paper\200users_5_base\200users_5_base.xlsx', sheet_name='Sheet3')
...
file_path = 'elapTimeUB_Base5_Heu_out_of_sample_in_FP_1(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base5_Heu_out_of_sample_in_FP_1(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
ElapTimeUB_M1=pd.DataFrame(elapsed_time_Replica_in_sample)
file_path = 'elapTimeUB_Base5_Heu_in_sample_in_FP_1(n,10_M,25).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj_Val_FP_out_of_sample)
file_path = 'ObjUB_Base5_Heu_in_sample_in_FP_1(n,10_M,25).xlsx'
#Ob_UB_M1.to_excel(file_path, index=False)
  #  aR=aR+T
