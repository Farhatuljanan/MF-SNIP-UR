# -*- coding: utf-8 -*-
"""
Created on Thu Dec 12 18:23:35 2024
...
file_path = 'elapsed time_base5_RM1_1(n,10_m,5).xlsx'
...
excel_file_path = 'combined_base5_RM1_1(n,10_m,5).xlsx'
...
# Specify the Excel file path
excel_file_path1 = 'Obj_valueLB_base5_RM1_1(n,10_m,5).xlsx'
...
file_path = 'elapTimeUB_Base5_RM1_Class1(n,10_M,5).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Objective_Value_UB)
file_path = 'ObjUB_Base5_RM1_Class1(n,10_M,5)_check.xlsx'
