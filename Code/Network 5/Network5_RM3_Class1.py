# -*- coding: utf-8 -*-
"""
Created on Thu Dec 12 18:25:43 2024
...
#data6= pd.read_excel(r'200users_4_base.xlsx', sheet_name='Sheet8',engine='openpyxl')
...
# Constraints: Ensure connectivity
    ...
    for s in S:
        ...
        for edge, rand in zip(Important_nodes_ResArcs_random_gen.edges(), rand_a_b[s]):
        ...
        for p,q in A.edges:
            Edge=(p,q)
            if Edge in Important_nodes_ResArcs_random_gen.edges:
                A[p][q]['Rand']=Important_nodes_ResArcs_random_gen[p][q]['Rand']
            else:
                A[p][q]['Rand']=0
...
file_path = 'elapsed time_base5_RM3_1(n,10_m,5).xlsx'
...
excel_file_path = 'combined_base5_RM3_1(n,10_m,5).xlsx'
...
# Specify the Excel file path
excel_file_path1 = 'Obj_valueLB_base5_RM3_1(n,10_m,5).xlsx'
...
file_path = 'elapTimeUB_Base5_RM3_Class1(n,10_M,5).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Objective_Value_UB)
file_path = 'ObjUB_Base5_RM3_Class1(n,10_M,5)_check.xlsx'
