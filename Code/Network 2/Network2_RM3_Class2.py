# -*- coding: utf-8 -*-
"""
Created on Thu Dec 12 19:15:26 2024
...
data6= pd.read_excel(r'D:\PhD Research\First_paper\200users_2_base\200users_2_base.xlsx', sheet_name='Sheet22')
#data1= pd.read_excel(r'NodeExpansionData.xlsx', sheet_name='Sheet1',engine='openpyxl')
#data2= pd.read_excel(r'200users_2_base.xlsx', sheet_name='Sheet20',engine='openpyxl')
#data3= pd.read_excel(r'200users_2_base.xlsx', sheet_name='NodeEx',engine='openpyxl')
#data4= pd.read_excel(r'200users_2_base.xlsx', sheet_name='Sheet19',engine='openpyxl')
#data5= pd.read_excel(r'200users_2_base.xlsx', sheet_name='Sheet23',engine='openpyxl')
#data6= pd.read_excel(r'200users_2_base.xlsx', sheet_name='Sheet22',engine='openpyxl')
...
S_ij_partial=nx.from_pandas_edgelist(data6, 'Source', 'Target', create_using=nx.DiGraph)
num_nodes=260
num_res_arcs=130
...
# Constraints: Ensure connectivity
    ...
    m.addConstrs(gp.quicksum(alpha[k,l,s] for k,l in S1[(i,j)])>=A[i][j]['Tau'] * alpha[i,j,s] for i,j in S_ij_partial.edges for s in S)
    rand_a_b = {}
...
file_path = 'elapsed time_base2_AM3_2(n,10_m,5).xlsx'
...
excel_file_path = 'combined_base2_AM3_2(n,10_m,5).xlsx'
...
# Specify the Excel file path
excel_file_path1 = 'Obj_valueLB_base2_AM3_2(n,10_m,5).xlsx'
...
file_path_pickle = 'z_values_base2_AM3_prac.pkl'
...
file_path = 'elapTimeUB_Base2_AM3_Class2(n,10_M,5).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Objective_Value_UB)
file_path = 'ObjUB_Base2_AM3_Class2(n,10_M,5)_check.xlsx'
