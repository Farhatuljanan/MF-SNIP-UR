...
file_path_pickle ='z_values_base2_Heu_ModCap_2(n_40,m_5)_B_20.pkl'  ##Interdiction Plan at Budget 20
# Load the dictionary from the pickle file
with open(file_path_pickle, 'rb') as pickle_file:
    Interdiction_Values = pickle.load(pickle_file)
    
file_path_pickle ='z_values_base2_Heu_ModCap_2(n_40,m_5)_B_40.pkl'  ##Interdiction Plan at Budget 40
# Load the dictionary from the pickle file
with open(file_path_pickle, 'rb') as pickle_file:
    Interdiction_Values1 = pickle.load(pickle_file)
    
file_path_pickle ='z_values_base2_Heu_ModCap_2(n_40,m_5)_B_60.pkl'  ##Interdiction Plan at Budget 60
...
for i in a_in:
    ...
    Final_interdiction[5+i]=Interdiction_Values1[i]
    Final_interdiction[10+i]=Interdiction_Values2[i]
...
file_path = 'elapTimeUB_Base2_MF_SNIP_UR_beforeRestruct_2(B_20_40_60).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj1)
file_path = 'ObjUB_Base2_MF_SNIP_UR_beforeRestruct_2(B_20_40_60).xlsx'
