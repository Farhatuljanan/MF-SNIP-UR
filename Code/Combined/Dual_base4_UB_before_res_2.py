...
file_path_pickle ='z_values_base4_Heu_ModCap_2(n_40,m_5)_B_20.pkl' ## Interdiction plan with Budget 20

# Load the dictionary from the pickle file
with open(file_path_pickle, 'rb') as pickle_file:
    Interdiction_Values = pickle.load(pickle_file)

file_path_pickle ='z_values_base4_Heu_ModCap_2(n_40,m_5)_B_40.pkl' ## Interdiction plan with Budget 40

# Load the dictionary from the pickle file
with open(file_path_pickle, 'rb') as pickle_file:
    Interdiction_Values1 = pickle.load(pickle_file)

file_path_pickle ='z_values_base4_Heu_ModCap_2(n_40,m_5)_B_60.pkl' ## Interdiction plan with Budget 60
...
file_path = 'elapTimeUB_Base4_MF_SNIP_UR_before_Restruc_2(B_20_40_60).xlsx'
#ElapTimeUB_M1.to_excel(file_path, index=False)
Ob_UB_M1=pd.DataFrame(Obj1)
file_path = 'ObjUB_Base4_MF_SNIP_UR_before_Restruc_2(B_20_40_60).xlsx'
